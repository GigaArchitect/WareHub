...
public class LoggedController {
    ...
    @FXML
    protected void onPurchaseReportsClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/nasar/mustafa/warehub/PurchaseReports.fxml"));
        Node purchaseReportsPane = loader.load();
        PurchaseReportsController purchaseReportsController = loader.getController();
        purchaseReportsController.setConnection(connection);
        rootPane.setCenter(purchaseReportsPane);
    }

    @FXML
    protected void onSalesAndPurchaseReportsClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/nasar/mustafa/warehub/SalesAndPurchaseReports.fxml"));
        Node salesAndPurchaseReportsPane = loader.load();
        SalesAndPurchaseReportsController salesAndPurchaseReportsController = loader.getController();
        salesAndPurchaseReportsController.setConnection(connection);
        rootPane.setCenter(salesAndPurchaseReportsPane);
    }

    @FXML
    protected void onShowInventoryClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/nasar/mustafa/warehub/ShowInventory.fxml"));
        Node showInventoryPane = loader.load();
        ShowInventoryController showInventoryController = loader.getController();
